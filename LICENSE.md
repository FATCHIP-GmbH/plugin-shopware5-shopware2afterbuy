...
1.  **Preamble:** This Agreement, signed on Dec 19, 2016 (hereinafter: Effective Date) governs the relationship between **YOU**, a Business Entity, (hereinafter: Licensee) and **FATCHIP GmbH**, a duly registered company in whose principal place of business is Helmholtzstrasse 2-9, 10587 Berlin (hereinafter: Licensor). This Agreement sets the terms, rights, restrictions and obligations on using Fatchip TwitterFeed (hereinafter: The Software) created and owned by Licensor, as detailed herein
